...
/*┌─────────────────────────────────────────────────────────────────────────────┐
 ...
 │ Do not reveal your answers here—just write and test in your own               │
 │ environment.                                                                  │
 └─────────────────────────────────────────────────────────────────────────────┘*/
...
/*┌─────────────────────────────────────────────────────────────────────────────┐
 ...
 │ • Values in a Set can be of any type, including objects.                      │
 ...
 │ • Methods: add, delete, has, clear, size, forEach, keys, values, entries      │
 │                                                                               │
