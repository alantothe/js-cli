...
// Example output: Map(7) { 'h' => 1, 'e' => 1, 'l' => 3, 'o' => 2, 'w' => 1, 'r' => 1, 'd' => 1 }
...
// Example output: Map(9) { 2 => 1, 3 => 2, 4 => 3, 5 => 5, 6 => 8, 7 => 13, 8 => 21, 9 => 34, 10 => 55 }
...
4. Advanced: Given a Map "userRoles" where keys are user IDs (numbers)
   ...
   Hint: Use Map’s forEach() or for...of on entries(), and build an array per role.
*/

/* ---------------------------------------------------------------------
 * NOTES/TIPS
 *
 * • Maps preserve insertion order—iteration happens in the order keys were added.
 *
 ...
 *
 * • If keys are always strings and you only need simple lookups, plain objects
 *   might suffice and have slightly less overhead.
 *
 * • To clear all entries from a Map, just call clear().
 * • To check for a key without retrieving its value, use has().
 * • To iterate in insertion order, use for...of or forEach().
 * • Converting between Maps and arrays is straightforward with Array.from().
 *
